...
export const metadata: Metadata = {
  ...
  description:
    'Explore all available subjects and find a verified expert tutor for the topic you need.'
}
    ...
    <div className='mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8'>
      <div className='mb-12 text-center'>
        ...
        <p className='mt-4 text-lg text-slate-500'>
          {categories.length} subject{categories.length !== 1 ? 's' : ''} taught
          by verified expert tutors. Pick a topic to see available tutors.
        </p>
      </div>
